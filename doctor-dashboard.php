                ...
                <nav class="navbar navbar-expand-lg header-nav">
                    ...
                    <ul class="nav header-navbar-rht">
                        ...
                        <!-- User Menu -->
                            <a href="login.html">
                                <span class="user-img">
                                    <img class="rounded-circle"  src="assets1/img/set.png" width="31" alt="Darren Elder">
                                </span>
				...
				<div class="container-fluid">
					<div class="row align-items-center">
						<div class="col-md-12 col-12">
							<h2 class="breadcrumb-title">Doctor Page</h2>
						</div>
					</div>
				</div>
			</div>
                                ...
                                <div class="dashboard-widget">
                                    <nav class="dashboard-menu">
                                        <ul>
                                            ...
                                            <li>
                                                <a href="docprofile.html">
                                                    <i class="fas fa-user"></i>
                                                    <span>Profile</span>
                                                </a>
                                            </li>
                                            <li>
                                                <a href="doclogin.html">
...
$sql = "SELECT Name,Date,Time,Phone FROM appointment";
$result = $conn->query($sql);

if (mysqli_query($conn, $sql)) {
    echo "<h2>Patient's List</h2><br>";
    echo "<table><tr><th>Name</th><th>Date </th><th>Time</th><th>Phone Number</th></tr>";
    while($row = $result->fetch_assoc()) {
         echo "<tr><td>" . $row["Name"]. "</td><td>" . $row["Date"]. "</td><td> " . $row["Time"]. "</td><td>" . $row["Phone"]."</td></tr>";
